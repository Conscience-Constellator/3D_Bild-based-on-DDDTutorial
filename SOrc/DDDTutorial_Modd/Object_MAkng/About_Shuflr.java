...
public class About_Shuflr<Object_Typ extends RL_LOc_Havr> extends Object_MAkr_Rapr<Object_Typ>
{
	public double Mag;
		@Override
		public Object_Typ MAk(Physc_SpAc SpAc,Object LOc_SOrc)
		{
			...
			((Tik_Tran)((SpAc_Object)Object).Get_Physc_LMNt("Tran")).TRget.Mov(Box_Shuflr.Shufl(current(),1));

			return Object;
		}

	public About_Shuflr(Object_MAkr<Object_Typ> Rapd,double Mag)
	{
		super(Rapd);
		this.Mag=Mag;
	}
